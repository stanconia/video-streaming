            ...
            {loadingContacts ? (
              ...
              <div style={styles.pickerEmpty}>
                {isTeacher
                  ...
                  : 'No teachers found. Enroll in a course to message its teacher.'}
              </div>
            ) : (
          ...
          >
            {selectedConversationId ? (
              ...
              <div style={styles.emptyMain}>
                {isTeacher
                  ? 'Select a conversation or click "+ New Message" to message a student'
