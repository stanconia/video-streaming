...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  newThreadButton: { padding: '10px 24px', backgroundColor: '#0d9488', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '15px', fontWeight: 'bold' },
  ...
  threadTitle: { margin: '0 0 6px 0', fontSize: '16px', color: '#0d9488' },
