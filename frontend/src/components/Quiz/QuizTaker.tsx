...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  startButton: { padding: '14px 48px', backgroundColor: '#0d9488', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '18px', fontWeight: 'bold' },
  ...
  toggleActive: { padding: '8px 20px', backgroundColor: '#0d9488', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '14px' },
  ...
  radio: { marginRight: '12px', accentColor: '#0d9488' },
  ...
  retryButton: { marginTop: '20px', padding: '10px 28px', backgroundColor: '#0d9488', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '15px' },
