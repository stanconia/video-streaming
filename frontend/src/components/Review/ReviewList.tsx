        ...
        <div key={review.id} style={styles.reviewCard}>
          ...
          {review.teacherReply && (
            <div style={styles.replyBox}>
              <span style={styles.replyLabel}>Guide reply:</span>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  replyBox: { backgroundColor: '#f8f9fa', padding: '12px', borderRadius: '6px', marginTop: '8px', borderLeft: '3px solid #0d9488' },
  replyLabel: { fontWeight: 'bold', fontSize: '12px', color: '#0d9488' },
  ...
  replyButton: { background: 'none', border: '1px solid #0d9488', borderRadius: '4px', padding: '4px 10px', cursor: 'pointer', fontSize: '12px', color: '#0d9488' },
  ...
  submitReply: { padding: '6px 14px', backgroundColor: '#0d9488', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '13px' },
